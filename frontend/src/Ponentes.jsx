...
const PONENTES = [
  ...
  { id: 2, nombre: 'Dra. Aline Guillermina Ramirez', puesto: 'HEMATOLOGÍA', foto: '/assets/ponente_aline_ramirez.png', biografia_larga: [
    ...
    'Su práctica clínica e investigación se centran en las gammapatías monoclonales y el mieloma multiple, liderado proyectos de investigación, participado en colaboraciones nacionales e internacionales y publicando en colaboración con COMMIMEX EL Consenso Mexicano de MielomaMúltiple 2026.',
